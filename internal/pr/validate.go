...
// beginning with `-` would be parsed by gh as a flag. Per
// docs/specs/submit-export.md the ref is a PR URL or a bare number, so
// rejecting leading dashes, whitespace, and control characters rejects nothing
// legitimate.
