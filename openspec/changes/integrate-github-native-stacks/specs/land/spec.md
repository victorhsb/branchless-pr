...
#### Scenario: Disabled land command remains unregistered
- **GIVEN** `land.style = disable`
- **WHEN** the CLI is initialized in any native mode
- **THEN** the `land` subcommand SHALL remain unregistered
